...
uses
  ...
  DataSetImpExpEh, DBGridEhXMLSpreadsheetExp, DBVertGridEhXMLSpreadsheetExp, 
  PlannerCalendarPickerEh, PlannerDataEh, PlannerDesignEditorsEh, PlannersEh, 
  PlannerToolCtrlsEh, SpreadGridsEh, XlsxFormatEh, XMLSpreadsheetFormatEh, 
  PlannerItemDialog, LazarusPackageIntf;
