...
resourcestring
  ...
  SSearchPanelApplyFilterEh = 'Montre les enregistrements où le texte a été trouvé';
  SSearchPanelCancelFilterEh = 'Annule le filtre et efface le texte recherché';
  ...
  SElapsedTimeEh = 'Temps écoulé';
  SPivotDataBuildingInProgressEh = 'Chargement des données du pivot en cours ...';
  SPressESCToCancelEh = 'Taper <Ech> pour annuler';

  SGrandTotalEh = 'Total général';
  STotalEh = 'Total';
  ...
  SPivotSliceYearDisplayNameEh = 'Année';
  ...
  SPivotSumFunctionCustomEh = 'Personalisé';

  SPlannerResourceUnassignedEh = 'Non assigné';
  SPlannerNextEventEh = 'Evènement suivant';
  SPlannerPriorEventEh = 'Evènement précédent';
  SPlannerDeletePlanItemEh = 'Effacer l''évènement?';
  SPlannerPeriodFromEh = 'Du';
  SPlannerPeriodToEh = 'Au';
  SPlannerWeekTextEh = 'SEMAINE';
  SPlannerEndTimeBeforeStartTimeEh = 'L''heure de fin est située avant l''heure de début!';
  ...
  SCaseSensitiveEh = 'Sensible à la casse';
  SWholeWordsEh = 'Mots entiers';
  SCloseInBracketsEh = '(Fermer)';

  SLabelColumnEh = 'Libellés de la colonne';
  SDataColumnEh = 'Données de la colonne';
