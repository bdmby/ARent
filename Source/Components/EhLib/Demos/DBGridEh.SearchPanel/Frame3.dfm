  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object DBGridEh1: TDBGridEh
        ...
        SearchPanel.OnCheckCellHitSearch = DBGridEh1SearchPanelCheckCellHitSearch
        SearchPanel.OnGetHighlightStrings = DBGridEh1SearchPanelGetHighlightStrings
        SortLocal = True
        TabOrder = 0
      ...
      object Panel2: TPanel
        ...
        object Label2: TLabel
          ...
          Height = 13
          Caption = 
            'Demo 3. Advanced Search. Every word in the SearchPanel is search' +
            'ed separately.'
        end
      end
    end
    object TabSheet2: TTabSheet
      Caption = 'The Demo Description'
      ImageIndex = 1
      object DBMemoEh1: TDBMemoEh
        ...
        Lines.Strings = (
            ...
            'The Demo shows how to use SearchPanel events to create Advanced ' +
            'Search.'
          ''
          
            'In this demo the text in the SearchPanel text editor is divided ' +
            'by space in words and every word is serached as '
          'inidividual eement in the grid.'
          ''
          'In the Demo type '#39'at ta'#39' text in the SearchPanel text editor.'
          'The Grid highlighs '#39'at'#39' and '#39'ta'#39' words.'
          ''
          'The next events is used:'
