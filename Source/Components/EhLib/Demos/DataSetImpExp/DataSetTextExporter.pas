...
{$IFDEF EH_LIB_6} Variants, {$ENDIF}
  ...
  ExtDlgs, DBCtrlsEh, EhLibJPegImage, EhLibGIFImage,
  EhLibPNGImage, CompoMansEh, Mask, ComCtrls;
...
type
  TfrDataSetExporter = class(TFrame)
    ...
    cbUseTimeWithDate: TDBCheckBoxEh;
...
begin
  ...
  te.ExportFormats.UseTimeWithDate := cbUseTimeWithDate.Checked;
  ...
  tc := GetTickCount;
  te.ExportToFile(DBEditEh1.Text, false, false);
